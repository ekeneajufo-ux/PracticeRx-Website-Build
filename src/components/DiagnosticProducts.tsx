...
const PRODUCTS: Product[] = [
  {
    ...
    price: 197,
    checkoutUrl: "https://buy.stripe.com/00wcN4cdL38f4lc10f6J200",
  },
  {
    tag: "Financial Tool",
  ...
  },
  {
    ...
    name: "EMR & Tech Stack Matchmaker",
    tagline: "Stop overpaying for software that doesn't fit",
    delivery: "Delivered in 48 hours",
    deliverables: [
      "Personalized top 3 EMR recommendations",
      "Full tech stack blueprint",
      "Monthly cost breakdown",
      "30-min Q&A call",
    ],
    price: 147,
    checkoutUrl: "https://buy.stripe.com/aFa28q0v31077xo10f6J203",
  },
  {
    tag: "Legal/Ops",
    tagColor: "bg-rose-50 text-rose-700",
    name: "Membership Agreement Review & Template",
    tagline: "Your contract is your foundation — get it right",
    delivery: "Delivered in 5 business days",
    deliverables: [
      "Annotated agreement review or new template",
      "Gap analysis with flagged risk areas",
      "Clean attorney-ready template",
      "45-min walkthrough call",
    ],
    price: 347,
    checkoutUrl: "https://buy.stripe.com/6oU7sKa5DgZ504W38n6J204",
  },
];
