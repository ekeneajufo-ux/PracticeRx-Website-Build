    ...
    <div className="bg-cream min-h-screen psych-product">
      ...
      <section className="product-hero">
        <div className="product-hero-content">
          <div className="hero-eyebrow">Digital Product — Immediate Download</div>
          ...
          <div className="hero-price-row">
            ...
            <div className="hero-price-meta">
              ...
              <div className="hero-price-sub">Instant PDF download · Lifetime access</div>
            </div>
          </div>
          <br />
      ...
      <div className="page-wrap">
        ...
        <div className="two-col">
          ...
          <div>
            ...
            <h2>Stop leaving money — and your sanity — on the table</h2>
            ...
            <p>The cash-based model is not a niche workaround. For psychiatry specifically, it is the most financially rational, clinically fulfilling, and professionally sustainable way to practice. This Blueprint gives you the exact blueprint to get there — not theory, not inspiration, but the actual operational tools you need to execute.</p>
            ...
            <ul className="module-list">
              <li>
                ...
                <div className="module-text">
                  ...
                  <p>Pre-built Excel/Google Sheets models for fee-for-service, membership, and hybrid revenue. Input your market, panel size, and fee structure — outputs projected annual revenue, overhead breakeven, and physician income. Three scenario modeling (conservative, base, optimistic).</p>
                </div>
              </li>
              <li>
                ...
                <div className="module-text">
                  ...
                  <p>A curated, physician-reviewed reference covering DPC and direct specialty care legal requirements across all 50 states. Know exactly what your state requires before you structure your membership model — no expensive attorney research required for the initial framework.</p>
                </div>
              </li>
              <li>
              ...
              <li>
                ...
                <div className="module-text">
                  ...
                  <p>A week-by-week action plan from decision to open doors. Entity formation, compliance review, space selection, technology setup, pre-launch marketing, and first-patient onboarding — all sequenced and prioritized so nothing falls through the cracks.</p>
                </div>
              </li>
              <li>
              ...
              <li>
                ...
                <div className="module-text">
                  ...
                  <p>A complete operational guide to adding ketamine infusions, TMS therapy, or Spravato to your cash practice. Covers equipment considerations, staffing models, compliance requirements, pricing strategy, and patient marketing — for each modality separately.</p>
                </div>
              </li>
              <li>
            ...
            <div className="testimonial">
              <p>"The revenue modeling template alone was worth the investment. I plugged in my market numbers and immediately understood exactly what panel size I needed at what fee to hit my income target. That single piece of clarity unblocked months of indecision."</p>
              <cite>— Psychiatrist, solo practice owner (Houston, TX)</cite>
            </div>
          </div>
